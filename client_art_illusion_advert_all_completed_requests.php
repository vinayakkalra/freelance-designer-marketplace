...
<head>
    ...
    <title>Art & illustration completed Request</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <?php
                    // completed 
                           $querysec = "SELECT * FROM `art_illusion_advert_requests` WHERE email = '".mysqli_real_escape_string($conn, $customeremail)."' AND status = 'Completed' order by id desc ";

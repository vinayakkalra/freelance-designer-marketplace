...
<head>
    ...
    <title>Art & illustration View Request</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <?php
                        ...
                        $querysec = "SELECT * FROM `art_illusion_advert_requests` WHERE orderid = '".mysqli_real_escape_string($conn, $request_id)."'  order by id desc limit 1" ;
                    ...
                    <div class="container " style="margin-bottom:20px;text-align: center;padding: 100px;">
                        ...
                        <?php
                                ...
                                while( $rowsec = mysqli_fetch_array($resultsec))
                                {
                                    ...
                                    if(($rowsec['type_of_design'] == "Card or invitation") or ($rowsec['type_of_design'] == "Greeting Card") or ($rowsec['type_of_design'] == "Illustration or graphics") or ($rowsec['type_of_design'] == "3D") or ($rowsec['type_of_design'] == "3D Architectural Rendering") or ($rowsec['type_of_design'] == "Other art or illustration")){

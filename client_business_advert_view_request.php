...
<head>
    ...
    <title>Business & advertising View Request</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <?php
                        ...
                        $querysec = "SELECT * FROM `business_advert_requests` WHERE orderid = '".mysqli_real_escape_string($conn, $request_id)."'  order by id desc limit 1" ;
                    ...
                    <div class="container " style="margin-bottom:20px;text-align: center;padding: 100px;">
                        ...
                        <?php
                                ...
                                while( $rowsec = mysqli_fetch_array($resultsec))
                                {
                                    ...
                                    if(($rowsec['type_of_design'] == "Brochure") or ($rowsec['type_of_design'] == "Booklet") or ($rowsec['type_of_design'] == "Pamphlet") ){
                                        ...
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">What is your organization name? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_is_your_organization'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- target audience  -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">Who is the target audience for your Product?  </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['Who_is_the_target_audience_for_your_Product'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- select industry -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                        ...
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;margin-right: 10px;font-weight: 500;">Do you have ideas about the visual style you want? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['Do_you_have_ideas_about_the_visual_style_you_want'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- product kind -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">What kind of Product do you want designed? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_kind_of_Product_do_you_want_designed'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- size paper -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">What size paper will your Product be using? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_size_paper_will_your_Product_be_using'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- front of product -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">What is required on the front of your Product? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_is_required_on_the_front_of_your_Product'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- body of product -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">What is required in the body of your Product? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_is_required_in_the_body_of_your_Product'] ?></h3>
                                            </div>
                                        </div>
                                        <!--  -->
                                        <!-- back cover -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;margin-right: 10px;font-weight: 500;">What is required on the back cover of your Product? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_is_required_on_ the_back_cover_of_your_Product'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- avoid -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                        ...
                                        <?php
                                    }elseif(($rowsec['type_of_design'] == "Banner") or ($rowsec['type_of_design'] == "Podcast") or ($rowsec['type_of_design'] == "Signage") ){
                                       ...
                                       <div class="row" style="display:flex;padding-bottom:20px;">
                                        ...
                                        <!--  -->
                                        <!-- described what u want designed -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;margin-right: 10px;font-weight: 500;">Describe what you want designed  : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['Describe_what_you_want_designed'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- communicated-->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                        ...
                        <div class="container " style="margin-bottom:20px;text-align: center;padding: 100px;">
                            ...
                            <?php
                                ...
                                while( $rowsec = mysqli_fetch_array($resultsec))
                                {
                                    ...
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What is your organization name? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['What_is_your_organization'] ?></h3>
                                        </div>
                                    </div>
                                    <!-- target audience -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">Who is the target audience for your Product? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['Who_is_the_target_audience_for_your_Product'] ?></h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        ...
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['Do_you_have_ideas_about_the_visual_style_you_want'] ?></h3>
                                        </div>
                                    </div>
                                    <!-- product kind -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What kind of Product do you want designed? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?=$rowsec['What_kind_of_Product_do_you_want_designed'] ?></h3>
                                        </div>
                                    </div>
                                    <!-- size paper-->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What size paper will your Product be using? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?=$rowsec['What_size_paper_will_your_Product_be_using'] ?></h3>
                                        </div>
                                    </div>
                                    <!-- product front -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What is required on the front of your Product?  : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?=$rowsec['What_kind_of_Product_do_you_want_designed'] ?></h3>
                                        </div>
                                    ...
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What is required in the body of your Product? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?=$rowsec['What_is_required_in_the_body_of_your_Product'] ?></h3>
                                        </div>
                                    </div>
                                    <!-- back of product -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What is required on the back cover of your Product? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?=$rowsec['What_is_required_on_ the_back_cover_of_your_Product'] ?></h3>
                                        </div>
                                    </div>
                                    <!-- anything to avoid -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                            ...
                            <?php
                                    ...
                                    <!-- describe what u want designed -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">Describe what you want designed : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['Describe_what_you_want_designed'] ?></h3>
                                        </div>
                                    </div>
                                     <!-- communicated -->
                                     <div class="row" style="display:flex;padding-bottom:20px;">

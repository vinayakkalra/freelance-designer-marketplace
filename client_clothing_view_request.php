...
<head>
    ...
    <title>Clothing & merchandise View Request</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <?php
                        ...
                        $querysec = "SELECT * FROM `clothing_requests` WHERE orderid = '".mysqli_real_escape_string($conn, $request_id)."'  order by id desc limit 1" ;
                    ...
                    <div class="container " style="margin-bottom:20px;text-align: center;padding: 100px;">
                        ...
                        <?php
                                ...
                                while( $rowsec = mysqli_fetch_array($resultsec))
                                {
                                    ...
                                    if(($rowsec['type_of_design'] == "T-shirt")){
                                        ...
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">Who is the t-shirt for? </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['Who_is_the_product_for'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- specofoc color in mind -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">Do you have any specific colors in mind? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['Do_you_have_any_specific_colors_in_mind'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- viual style -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                        ...
                                        <!-- kind of shirt designed -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">What kind of t-shirt do you want designed? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                        ...
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">What is required on the t-shirt? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_is_required_on_the_product'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- avoid anything -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                        ...
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                ...
                                                <h3 style="margin-left: 40px;font-weight: 500;">Do you have a logo you want on the t-shirt? </h3>
                                        ...
                                        <?php
                                    }elseif(($rowsec['type_of_design'] == "Clothing or apparel") or ($rowsec['type_of_design'] == "Jersey") or ($rowsec['type_of_design'] == "Sweatshirt & Hoodie") ){
                                        ...
                                        <!-- product want designed -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">What Product do you want designed? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_kind_of_product_do_you_want_designed'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- descrive product and purpose -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">Describe your Product and its purpose : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['Describe_your_product_and_its_purpose'] ?></h3>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">What is required on the Product? : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_is_required_on_the_product'] ?></h3>
                                            </div>
                                        ...
                                        <?php
                                    }elseif(($rowsec['type_of_design'] == "Merchandise") or ($rowsec['type_of_design'] == "Other clothing or merchandise") ){
                                        ...
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            ...
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['What_is_your_organization_name'] ?></h3>
                                            </div>
                                        </div>
                                        <!-- select industry -->
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                        ...
                                        <div class="row" style="display:flex;padding-bottom:20px;">
                                            <div style="width:50%">
                                                <h3 style="margin-left: 40px;font-weight: 500;">Describe what you want designed : </h3>
                                            </div>
                                            <div style="width: 50%;">
                                                <h3><?= $rowsec['Describe_your_product_and_its_purpose'] ?></h3>
                                            </div>
                        ...
                        <div class="container " style="margin-bottom:20px;text-align: center;padding: 100px;">
                            ...
                            <?php
                                ...
                                while( $rowsec = mysqli_fetch_array($resultsec))
                                {
                                    ...
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">Who is the t-shirt for? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['Who_is_the_product_for']?></h3>
                                        </div>
                                    </div>
                                    <!-- specifi color in mind -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">Do you have any specific colors in mind? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['Do_you_have_any_specific_colors_in_mind'] ?></h3>
                                        </div>
                                    </div>
                                    <!-- visual style -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                    ...
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What kind of t-shirt do you want designed? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                    ...
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What is required on the t-shirt? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['What_is_required_on_the_product'] ?></h3>
                                        </div>
                                    </div>
                            ...
                            <?php
                                    ...
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What Product do you want designed? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['What_kind_of_product_do_you_want_designed'] ?></h3>
                                        </div>
                                    </div>
                                    <!-- describe product and its purpose -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">Describe your Product and its purpose : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['Describe_your_product_and_its_purpose'] ?></h3>
                                        </div>
                                    </div>
                                   <!-- required on product -->
                                   <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">
                                            <h3 style="margin-left: 20px;font-weight: 500;">What is required on the Product? : </h3>
                                        </div>
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['What_is_required_on_the_product'] ?></h3>
                                        </div>
                            ...
                            <?php
                                    ...
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        ...
                                        <div style="width: 100%;">
                                            <h3 style="margin-left: 20px;"><?= $rowsec['What_is_your_organization_name'] ?></h3>
                                        </div>
                                    </div>
                                    <!-- selec industry -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                    ...
                                    <!-- describe organisation or product does -->
                                    <div class="row" style="display:flex;padding-bottom:20px;">
                                        <div style="width:100%">

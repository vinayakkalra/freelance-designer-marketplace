...
<head>
    ...
    <title>View Completed Request</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <?php
                        ...
                        $querysec = "SELECT * FROM `designer_completed_requests` WHERE designer_email = '".mysqli_real_escape_string($conn, $customeremail)."' AND request_id = '".mysqli_real_escape_string($conn, $request_id)."' AND status = 'Completed' order by id desc limit 1" ;

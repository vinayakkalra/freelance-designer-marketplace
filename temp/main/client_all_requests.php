            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    $variablless = 0;
                           ...
                           $querysec = "SELECT * FROM `requests` WHERE (email = '".mysqli_real_escape_string($conn, $customeremail)."') AND (status = 'Submitted' OR status = 'Processing' OR status = 'redo' OR status = 'Pending' ) ";
                            ...
                            else if($rowsec['status'] == "Pending")
                            {
                                ...
                                <div class="row request_show">
                                    ...
                                    <div style="width:20%">
                                        ...
                                        <div style="width:20%">
                                        <a class="btn btn-primary addItemBtn" href="client_view_pending_request.php?request_id=<?= $rowsec['id'] ?>" style="color:#fff;" type="button">
                                            View Design
                                            </a>
                                    </div>
                                </div>
                    ...
                    <!-- completed -->
                     <?php
                           $querysec = "SELECT * FROM `requests` WHERE email = '".mysqli_real_escape_string($conn, $customeremail)."' AND status = 'Completed' order by id desc limit 10";
                        if ($resultsec = mysqli_query($conn, $querysec)) {
                    ...
                    <?php
                            ...
                            <div class="row" style="padding: 20px;text-align: initial;">
                                <div style="width: 100%;">
                                    <a href="client_all_completed_requests.php" class="btn btn-primary addItemBtn" style="color:#fff;" type="button">
                ...
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <?php
                            ...
                            while( $rowsec = mysqli_fetch_array($resultsec)){
                                ...
                                if( $rowsec['status'] == "Redo" or $rowsec['status'] == "Submitted"  or $rowsec['status'] == "Rrocessing")
                            {  
                                ?>
                    <!--  -->
                            <div class="row request_show">
                            ...
                            } else if($rowsec['status'] == "Pending")
                            {
                                ...
                                <div class="row request_show">
                                    ...
                                    <div style="width:45%">
                                        ...
                                        <p>
                                            <a class="btn btn-primary" href="client_view_pending_request.php?request_id=<?= $rowsec['id'] ?>"
                                            data-purpose="keep-shopping-action">
                                            View Design
                                            </a>
                                        </p>

        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Accepted Requests</h3>
                </div>
            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <?php
                        $querysec = "SELECT * FROM `requests` WHERE designer_accept_email = '".mysqli_real_escape_string($conn, $customeremail)."' AND status = 'accepted'";
            ...
            <div class="d-lg-none">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <div class="row" style="display:flex;padding-bottom:20px;">
                        ...
                        <div style="width:45%">
                            <h4>View Request & Submit Design</h4>
                        </div>
                        <!-- <div style="width:30%">

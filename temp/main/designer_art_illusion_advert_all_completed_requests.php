        ...
        <div class="page-wrapper">
            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <?php
                    // completed 
                           $querysec = "SELECT * FROM `art_illusion_advert_requests` WHERE designer_accept_email = '".mysqli_real_escape_string($conn, $customeremail)."' AND status = 'Completed' order by id desc ";
                    ...
                    <?php
                                ...
                                if( $rowsec['status'] == "Completed")
                            {
                                ...
                                <div class="row request_show">
                                    ...
                                    <div style="width:45%">
                                        <p>
                                            <a class="btn btn-primary" href="designer_view_request.php?requestid=<?= $rowsec['orderid'] ?>"
                                            data-purpose="keep-shopping-action">
                                            View Request
                                            </a>
                                        </p>

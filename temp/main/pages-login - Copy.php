                    ...
                    if (isset($row)) {
                        ...
                        if ($hashedPassword == $row['password']) {
                            ...
                            if (isset($_POST['stayLoggedIn']) AND $_POST['stayLoggedIn'] == '1') {
                                ...
                                setcookie("iddashboard", $row['id'], time() + 60*60*24*365);
                            ...
                            <form class="form-horizontal form-material" id="logInForm" method="post">
                                ...
                                <div class="form-group" style="display: flex;">
                                    <div style="width: 40%;align-items: center;display: flex;">
                                        <label class="form-control" style="margin-bottom: 3px;">Log In as </label>
                                    </div>
                                    <div style="width: 60%;">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                                ...
                                <div class="form-group m-b-0">
                                    <div class="col-sm-12 text-center">
                                        <div>Don't have an account? <a href="pages-register - Copy.php"

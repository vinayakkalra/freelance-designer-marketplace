        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Your Accepted Requests</h3>
                </div>
            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <?php
                        $querysec = "SELECT * FROM `requests` WHERE email = '".mysqli_real_escape_string($conn, $customeremail)."' AND status = 'accepted'";
                    ...
                    <?php
                            ...
                            while( $rowsec = mysqli_fetch_array($resultsec)){
                                ...
                                if( $rowsec['status'] == "accepted")
                            {  
                                ?>
                    <!--  -->
                    <div onclick="window.location='client_view_request.php?requestid=<?= $rowsec['id'] ?>';"
                        class="row request_show">
                        <div style="width:15%;">

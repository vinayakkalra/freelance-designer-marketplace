            ...
            <div class="d-none d-lg-block">
                <div class="container-fluid" style="background-color:#fff;padding-top:20px;">
                    ...
                    <div class="row" style="display:flex;padding-bottom:20px;">
                        ...
                        <div style="width:25%">
                            <p><?= $rowsec['project_name'] ?></p>
                        </div>
                        <div style="width:20%">
                            <p><?= $rowsec['type_of_design'] ?></p>
                        </div>
                        <div style="width:30%">
                            <p><?= $rowsec['how_design_be_used'] ?></p>
                        </div>
                        <div style="width:15%">
                            <a class="mobcourselink" href="processing_request.php?requestid=<?= $rowsec['id'] ?>">
                                <p>View Request</p>
                            </a>
                        </div>
                    </div>
